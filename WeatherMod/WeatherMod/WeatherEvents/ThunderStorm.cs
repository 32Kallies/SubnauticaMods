...
public class Thunderstorm : WeatherEvent
{
    ...
    protected override FogSettings Fog { get; } = new FogSettings(0.0023f, new Color(0.06f, 0.075f, 0.1f), 0.4f, 0.45f, 0.3f);
    public override float MinDuration { get; } = 3.5f * 60;
    public override float MaxDuration { get; } = 7 * 60;
    ...
    protected override void OnEventBegin(GameObject effectPrefab)
    {
        ...
        effectPrefab.transform.Find("FarRain").gameObject.EnsureComponent<UpdateRainParticleDensity>();
    }
