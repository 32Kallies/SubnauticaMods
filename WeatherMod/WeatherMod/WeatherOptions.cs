...
public class WeatherOptions : ConfigFile
{
    ...
    [Slider("Rain density multiplier", 1, 10, DefaultValue = 5,
        Tooltip = "This setting controls the number of particles in the rain. Higher values can affect performance.", Format = "{0:F1}x", Step = 0.1f)]
    public float RainDensityMultiplier = 5f;
